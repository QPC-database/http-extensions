...
- Digest algorithm name: the token value. The registry can be used to reserve token values
...
Values to be added to this registry require IETF Review (see Section 4.8 of {{IANA=RFC8126}}).
